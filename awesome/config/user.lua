...
return {
  ...
  profile_picture = nil,
  username_override = nil,
  hostname_override = 'hostname',
  welcome_text = false, -- When enabled, the text says 'Welcome, [user]' instead of [user]@[host]. This will also happen if the program cannot find a hostname and hostname_override is nil.
}
